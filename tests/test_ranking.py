...
class TestComputeInstrumentRanks:
    ...
    def test_compute_instrument_ranks_swiss_client_empty_instruments(self):
        rating = ranking.compute_instrument_ranks([], ch_cl=True)
        assert 0 == rating
    ...
    def test_compute_instrument_ranks_swiss_client(self):
        ...
        rating = ranking.compute_instrument_ranks(instruments, ch_cl=True)
        assert 7 == rating
    ...
    def test_compute_instrument_ranks_non_swiss_client_empty_instruments(self):
        rating = ranking.compute_instrument_ranks([], ch_cl=False)
        assert rating == 0
    ...
    def test_compute_instrument_ranks_non_swiss_client(self):
        ...
        rating = ranking.compute_instrument_ranks(instruments, ch_cl=False)
        assert 200 == rating
